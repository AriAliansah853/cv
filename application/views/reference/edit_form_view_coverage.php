			        ...
			        <div class="row mb-2">
			          	...
			          	<div class="col-sm-6">
			            	<ol class="breadcrumb float-sm-right">
			              		...
			              		<li class="breadcrumb-item"><a href="#">Coverage</a></li>
			        ...
			        <div class="row">
						...
						<div class="card card-danger">
				              	<div class="card-header">
				                	<h3 class="card-title">Edit Coverage</h3>
				              	</div>
				              	<!-- <?php $data = $this->db->query("SELECT * FROM userlogin where login_id = '".$inser_user."'");
				              		$User = $data->row_array();
				              	?> -->
				              	<form role="form" action="<?php echo base_url('reference/update_coverage/'.$id);?>" method="post" >
					                <div class="card-body">
					                  	<div class="form-group">
						                    <label>Coverage Name</label>
						                    <input type="text" name="coverage" class="form-control" value="<?php echo $nama_coverage; ?>">
					                  	</div>
					                  	<div class="form-group">
						                    <label>Visible</label>
