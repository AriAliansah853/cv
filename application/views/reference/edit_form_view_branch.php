			        ...
			        <div class="row">
						...
						<div class="card card-danger">
				              	...
				              	<!-- <?php $data = $this->db->query("SELECT * FROM userlogin where login_id = '".$inser_user."'");
				              		$User = $data->row_array();
				              	?> -->
				              	<form role="form" action="<?php echo base_url('reference/update_branch/'.$id);?>" method="post" >
					                <div class="card-body">
					                  	<div class="form-group">
						                    <label>Branch Name</label>
						                    <input type="text" name="branch" class="form-control" value="<?php echo $nama_branch; ?>">
					                  	</div>
					                  	<div class="form-group">
						                    <label>Visible</label>
