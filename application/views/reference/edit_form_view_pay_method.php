...
<body class="hold-transition sidebar-mini">
			        ...
			        <div class="row mb-2">
			          	...
			          	<div class="col-sm-6">
			            	<ol class="breadcrumb float-sm-right">
			              		...
			              		<li class="breadcrumb-item"><a href="#">Pay Method</a></li>
			              		<li class="breadcrumb-item active">Edit Pay Method</li>
			            	</ol>
			          	</div>
			        </div>
		     	 </div>
			        ...
			        <div class="row">
						...
						<div class="card card-danger">
				              	<div class="card-header">
				                	<h3 class="card-title">Edit Pay Method</h3>
				              	</div>
				              	<!-- <?php $data = $this->db->query("SELECT * FROM userlogin where login_id = '".$inser_user."'");
				              		$User = $data->row_array();
				              	?> -->
				              	<form role="form" action="<?php echo base_url('reference/update_pay_method/'.$id);?>" method="post" >
					                <div class="card-body">
					                  	<div class="form-group">
						                    <label>Nama Pay Method</label>
						                    <input type="text" name="pay_method" class="form-control" value="<?php echo $nama_pay_method; ?>">
					                  	</div>
					                  	<div class="form-group">
						                    <label>Visible</label>
	...
	<script>
	var urlAdd="<?php echo base_url('reference/add_pay_method');?>";
	var link="<?php echo base_url('reference/edit_pay_method/').''.$rpay_method_id;?>";
	  	$(function () {
	    	$("#example1").DataTable();
	    	$('#example2').DataTable({
	      		"paging": true,
