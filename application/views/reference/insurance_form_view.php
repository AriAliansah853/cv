			          	...
			          	<div class="col-md-12">
			            	...
			            	<div class="card card-danger">
				              	<div class="card-header">
				                	<h3 class="card-title">Tambah Insurance</h3>
				              	</div>
				              
				              	<form role="form" action="<?php echo base_url();?>reference/save_insurance" method="post" >
					                <div class="card-body">
					                  	
					                  	<div class="form-group">
						                    <label>Insurance Name</label>
						                    <input type="text" name="insurance" class="form-control" placeholder="Insurance Name">
					                  	</div>
					                  	<div class="form-group">
						                    <label>Visible</label>
	...
	<script>
		...
		var cekError=<?php echo $errorData?>;
		 if(cekError == 0){
            ...
            .then((Ok) => {
                $('#btnSubmit').text('Tambah Insurance Gagal'); 
