...
<body class="hold-transition sidebar-mini">
			        ...
			        <div class="row">
						...
						<div class="card card-danger">
				              	...
				              	<!-- <?php $data = $this->db->query("SELECT * FROM userlogin where login_id = '".$inser_user."'");
				              		$User = $data->row_array();
				              	?> -->
				              	<form role="form" action="<?php echo base_url('reference/update_menu/'.$id);?>" method="post" >
					                <div class="card-body">
					                  	<div class="form-group">
						                    <label>Nama Menu</label>
						                    <input type="text" name="menu" class="form-control" value="<?php echo $nama_menu; ?>">
					                  	</div>
					                  	<div class="form-group">
						                    <label>Desc Menu</label>
						                    <input type="text" name="desc_menu" class="form-control" value="<?php echo $desc_menu; ?>">
					                  	</div>
	...
	<script>
	var urlAdd="<?php echo base_url('reference/add_branch');?>";
	var link="<?php echo base_url('reference/edit_branch/').''.$rbranch_id;?>";
	  	$(function () {
	    	$("#example1").DataTable();
	    	$('#example2').DataTable({
	      		"paging": true,
