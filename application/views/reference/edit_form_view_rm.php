...
<body class="hold-transition sidebar-mini">
			        ...
			        <div class="row mb-2">
			          	...
			          	<div class="col-sm-6">
			            	<ol class="breadcrumb float-sm-right">
			              		...
			              		<li class="breadcrumb-item active">Edit RM</li>
			            	</ol>
			          	</div>
			        </div>
		     	 </div>
			        ...
			        <div class="row">
						...
						<div class="card card-danger">
				              	<div class="card-header">
				                	<h3 class="card-title">Edit RM</h3>
				              	</div>
				              	<!-- <?php $data = $this->db->query("SELECT * FROM userlogin where login_id = '".$inser_user."'");
				              		$User = $data->row_array();
				              	?> -->
				              	<form role="form" action="<?php echo base_url('reference/update_rm/'.$id);?>" method="post" >
					                <div class="card-body">
					                  	<div class="form-group">
						                    <label>Nama RM</label>
						                    <input type="text" name="rm" class="form-control" value="<?php echo $nama_rm; ?>">
					                  	</div>
					                  	<div class="form-group">
						                    <label>Visible</label>
	...
	<script>
	var urlAdd="<?php echo base_url('reference/add_rm');?>";
	var link="<?php echo base_url('reference/edit_rm/').''.$rm_id;?>";
	  	$(function () {
	    	$("#example1").DataTable();
	    	$('#example2').DataTable({
	      		"paging": true,
