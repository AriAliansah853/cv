			          	...
			          	<div class="col-md-12">
			            	...
			            	<div class="card card-danger">
				              	<div class="card-header">
				                	<h3 class="card-title">Tambah Pay Method</h3>
				              	</div>
				              
				              	<form role="form" action="<?php echo base_url();?>reference/save_pay_method" method="post" >
					                <div class="card-body">
					                  	
					                  	<div class="form-group">
						                    <label>Nama Pay Method</label>
						                    <input type="text" name="pay_method" class="form-control" placeholder="Nama Pay Method">
					                  	</div>
					                  	<div class="form-group">
						                    <label>Visible</label>
	...
	<script>
		...
		var cekError=<?php echo $errorData?>;
		 if(cekError == 0){
            ...
            .then((Ok) => {
                $('#btnSubmit').text('Tambah Pay Method Gagal'); 
