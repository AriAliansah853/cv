			          	...
			          	<div class="col-md-12">
			            	...
			            	<div class="card card-danger">
				              	<div class="card-header">
				                	<h3 class="card-title">Tambah Coverage</h3>
				              	</div>
				              
				              	<form role="form" action="<?php echo base_url();?>reference/save_coverage" method="post" >
					                <div class="card-body">
					                  	
					                  	<div class="form-group">
						                    <label>Coverage Name</label>
						                    <input type="text" name="coverage" class="form-control" placeholder="Coverage Name">
					                  	</div>
					                  	<div class="form-group">
						                    <label>Visible</label>
